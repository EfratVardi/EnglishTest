(function(window) {
  ...
  var recordWavWorker = new Worker(js_directory() + '/enc/wav/recorderWorker.js');
  var encoderMp3Worker = new Worker(js_directory() + '/enc/mp3/mp3Worker.js');
    ...
    */
    ...
    function endFile(blob, extension) {
		if(blob.type == 'audio/mp3'){
			...
			jQuery('#record_element source').remove();
			jQuery('#record_element').append('<source src="' + url + '" type="' + blob.type + '" />');
